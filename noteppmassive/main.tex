...
\begin{align*}
	...
	&= \di x_1\,\di x_2\,(\partial_{x_2}I^{(\tau)}_{\bm n})\,x_1^{-b_0}x_2^{-b_0-1}\,\mG^{-\ep}\mK^{\ep} 
	...
	- \di x_1\,\di x_2\,(\partial_{x_2}\Omega_{x_2})_{\bm n \bm m}\,x_1^{-b_0}x_2^{-b_0-1}\,I^{(\tau)}_{\bm m}\,\mG^{-\ep}\mK^{\ep} \n\\
	&= -\di x_1\,I^{(\tau)}_{\bm n}\,\di\!\left( x_1^{-b_0}x_2^{-b_0-1}\,\mG^{-\ep}\mK^{\ep} \right) 
	- \di x_1\,\di x_2\,(\partial_{x_2}\Omega_{x_2})_{\bm n \bm m}\,x_1^{-b_0}x_2^{-b_0-1}\,I^{(\tau)}_{\bm m}\,\mG^{-\ep}\mK^{\ep} \n\\
...
The master integrals for the $\tau$-dependent subfamily are denoted by $I^{(\tau)}_{\bm n}$, where the index vector $\bm n=\{n_3,n_4\}$ labels the Hankel function orders.
...
\begin{align}
	I^{(\tau)}_{\bm n}(x_2;P_0)\equiv \int_{-\infty}^0 \di\tau\,\hat{I}^{(R)}_{\bm n},
\end{align}
where
\begin{align}
...
\begin{align}
	\di I^{(\tau)}_{\bm m}=\left(\di\Omega^{(R)}_{\bm m\bm n}\right)\,I^{(\tau)}_{\bm n},
\end{align}
