...
MIdlogTuw = (MIdlogKira /. repR12num);
...
*)
MIdlogNote = MIdlogNote /. repNumericTest;   (* <-- comment for symbolic run *)
...
DEk00 = (((DEk00raw /. repR12num) /. repreduce)) // Expand;
...
DEks0 = (((DEks0raw /. repR12num) /. repreduce)) // Expand;
