...
OmegaExplicit = OmegaP0Ref * Log[P0] + 
                Omegax2Ref * Log[x2] + 
                OmegaPlusRef * Log[P0 + 2*x2] + 
                OmegaMinusRef * Log[P0 - 2*x2];
...
Save[outputOmegaFile, "OmegaP0Ref"];
