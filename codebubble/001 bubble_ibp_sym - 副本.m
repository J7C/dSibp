...
basisd123OmegaTop = repdimplus2 /@ basisd1OmegaTop /. reppowerselection // Simplify // symmetry // DeleteDuplicates // Complement[#, {0}] &;

basisd3OmegaTop
basisd1OmegaTop


{(*Table[G[{n1,n2,n3,n4},{0,0},{0,1}],{n2,0,1},{n4,0,1},{n1,0,1},{n3,0,1}]//Flatten,*)
Table[G[{n1,n2,n3,n4},{0,0},{0,1}],{n1,0,1},{n3,0,1},{n2,0,1},{n4,0,1}]//Flatten,
basisd12SeedTopTau[[1;;16]]}/.G[c1_,c2_,c3_]->G[c1]//Transpose//MatrixForm
...
vec3Da1CorrR1 = vec3Da1R1 + (I/P0R1) * OmegaP0Ref . (MIsR1 /. {a -> 0, b1 -> 2, b2 -> 1}) // Simplify;
...
vec1Da100CorrR1 = vec1Da100R1 + (I/P0R1) * OmegaP0Ref . vec1Da000R1;

basis1DR1 = Join[
  vec1Da010R1,
  vec1Da001R1,
  vec1Da100CorrR1
] /. reppowerselection//symmetry // Complement[#, {0}] & // DeleteDuplicates // Simplify;

basis1D3DR1 = (repdimplus2 /@ basis1DR1) /. reppowerselection // Complement[#, {0}] & // DeleteDuplicates // Simplify;
...
MIdlogNote0 = Join[MIdlogTop0, MIdlogR10] // Flatten;
MIdlogNote = Join[MIdlogTop, MIdlogR1] // Flatten;
...
MIdlogR1/. repvar /. reppara2N//Simplify
%//Length
MIsR1
